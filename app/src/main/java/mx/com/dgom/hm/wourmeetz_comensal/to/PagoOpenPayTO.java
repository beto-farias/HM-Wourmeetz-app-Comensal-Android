...
public class PagoOpenPayTO implements Serializable {
    ...
    private TarjetaTO datos_tarjeta_op;
    ...
    public TarjetaTO getDatos_tarjeta_op() {
        return datos_tarjeta_op;
    }

    public void setDatos_tarjeta_op(TarjetaTO datos_tarjeta_op) {
        this.datos_tarjeta_op = datos_tarjeta_op;
    }
}
